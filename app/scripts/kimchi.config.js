...
var KIMCHI = (function (KIMCHI, _, THREE) {
  ...
  handlers.controlsKeyboardSpeedMultiplier = function (value) {
    ...
    KIMCHI.keyboardControls.options.zSpeed = settings.controlsZSpeed;
    KIMCHI.keyboardControls.options.strafeSpeed = settings.controlsStrafeSpeed;
    KIMCHI.keyboardControls.options.rollSpeed = settings.controlsRollSpeed;
  };
