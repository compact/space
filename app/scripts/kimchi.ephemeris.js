...
var KIMCHI = (function (KIMCHI) {
  ...
  /**
   * Keplerian elements and rates from {@link
  ...
  elements['1800ADTo2050AD'].Earth = { // TODO: actually EarthMoonBarycenter
    'a0': 1.00000261,
    'e0': 0.01671123,
    'I0': -0.00001531,
    'L0': 100.46457166,
  ...
  elements['3000BCTo3000AD'].Earth = { // TODO: actually EarthMoonBarycenter
    'a0': 1.00000018,
    'e0': 0.01673163,
    'I0': -0.00054346,
    'L0': 100.46691572,
  ...
  /**
   * Compute the position on the J2000.0 ecliptic plane with the given
   *   Keplerian elements at time T; the 5 steps of this algorithm are from
   *   {@link http://ssd.jpl.nasa.gov/txt/aprx_pos_planets.pdf}.
   * @param  {Number} rad
   * @return {Number}
   * @private
   * @memberOf module:KIMCHI.ephemeris
   ...
   * @param    {String} name
   * @param    {Number} julian
   * @returns  {Array}  The [x, y, z] position of the planet with the given name
   *   on the given Julian Day Number. The position is on the J2000.0 ecliptic
   *   plane.
   * @memberOf module:KIMCHI.ephemeris
   */
  ephemeris.getPositionArray = function (name, julian) {
    ...
    return getPlanetPositionArrays(T, elementsAtT[name]);
  };
